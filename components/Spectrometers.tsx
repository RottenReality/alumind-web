...
const Spectrometers = () => {
  ...
  },
  {
    ...
    url: "/images/spec-artus10.png",
  },
];

  return (
    <section id="services" className="py-20 bg-muted/30 bg-gradient-to-r from-gray-50 via-slate-100 to-blue-100">
